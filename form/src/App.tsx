  ...
  return (
    <Router>
      <Routes>
            ...
            <>
              <form onSubmit={handleSubmit(onSubmit)}>
                <div>
                  ...
                  <br />
                  {errors.nome && (
                    <span style={{ color: "#646cff" }}>{errors.nome.message}</span>
                  )}
                </div>
                ...
                <div>
                  ...
                  <br />
                  {errors.email && (
                    <span style={{ color: "#646cff" }}>{errors.email.message}</span>
                  )}
                </div>
                ...
                <div>
                  ...
                  <br />
                  {errors.idade && (
                    <span style={{ color: "#646cff" }}>{errors.idade.message}</span>
                  )}
                </div>
                ...
                <div>
                  ...
                  <br />
                  {errors.sexo && (
                    <span style={{ color: "#646cff" }}>{errors.sexo.message}</span>
                  )}
                </div>

                <button type="submit">
                  {editIndex !== null ? "Salvar" : "Enviar"}
                </button>
                {editIndex !== null && (
                  <button
                    type="button"
              ...
              <table>
                ...
                <tbody>
                  {submissoes.map((item, idx) => (
                    <tr key={idx}>
                      <td>
                        <Link to={`/user/${idx}`}>{item.nome}</Link>
                      </td>
                      <td>{item.email}</td>
                      <td>{item.idade}</td>
                      <td>{item.sexo}</td>
        ...
        />
        <Route path="/user/:id" element={<UseTodo />} />
      </Routes>
    </Router>
  )
}